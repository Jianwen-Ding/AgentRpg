...
public class Healstation : GenericMove
{
    ...
    public override void ActivateMove()
    {
        ...
        Gridinfo.AllGrids[(int)Character_Info.LocationAction.y][(int)Character_Info.LocationAction.x].GetComponent<GridControl>().StatusIndex = 8;
    }
}
