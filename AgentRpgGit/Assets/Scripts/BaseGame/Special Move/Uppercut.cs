...
public class Uppercut : GenericMove
{
    ...
    public override void ActivateMove()
    {
        ...
        for (int x = 0; x < AreaCheck((int)Character_Info.LocationAction.x, (int)Character_Info.LocationAction.y, 1, 1).Length; x++)
        {
            ...
            if (AreaCharacters[x] != null)
            {
                ...
                {
                    CheckedCharacterBase.Health -= CheckedCharacterBase.DefenseProcessedDamage((UppercutExponentialChange * Character_Info.ExpressedDamage)* (UppercutExponentialChange * Character_Info.ExpressedDamage));
                    ...
                    InWorldText.GetComponent<FadeOutText>().BeginInitiate(1, ""+ CheckedCharacterBase.DefenseProcessedDamage((UppercutExponentialChange * Character_Info.ExpressedDamage) * (UppercutExponentialChange * Character_Info.ExpressedDamage)), Color.black, new Vector2(5, 5));
                }
            }
        }
    }
