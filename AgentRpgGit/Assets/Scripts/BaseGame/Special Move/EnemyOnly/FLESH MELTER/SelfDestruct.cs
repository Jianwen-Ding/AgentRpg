...
public class SelfDestruct : GenericMove
{
    [SerializeField]
    int priorityChange = 70;
    ...
    public override void ActivateMove()
    {
        ...
        for (int x = 0; x < AreaCheck((int)Character_Info.CharacterLocationIndex.x - 1, (int)Character_Info.CharacterLocationIndex.y - 1, 3, 3).Length; x++)
        {
            ...
            if (AreaCharacters[x] != null)
            {
                ...
                {
                    CheckedCharacterBase.Health -= 100;
                    ...
                    InWorldText.GetComponent<FadeOutText>().BeginInitiate(1, 100 + "", Color.black, new Vector2(5, 5));
