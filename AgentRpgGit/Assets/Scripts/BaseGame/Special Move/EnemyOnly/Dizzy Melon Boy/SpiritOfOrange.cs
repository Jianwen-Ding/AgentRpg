...
public class SpiritOfOrange : GenericMove
{
    ...
    public override void SetAdjust()
    {
        ...
        WillUseForSquareX1 = -1;
        WillUseForSquareY1 = 1;
        WillUseForSquareWidth1 = 1;
        WillUseForSquareHeight1 = 1;
        WillUseForSquareX2 = 1;
        WillUseForSquareY2 = -1;
        WillUseForSquareWidth2 = 1;
        WillUseForSquareHeight2 = 1;
        WillUseForSquareX3 = -1;
        WillUseForSquareY3 = -1;
        WillUseForSquareWidth3 = 1;
        WillUseForSquareHeight3 = -1;
    ...
    public override int[] CheckIfConditionsApply(Vector2 areaCheckFrom)
    {
        ...
        if (willUseForGridEffect && TurnsHad > 4)
        {
    ...
    public override void ActivateMove()
    {
        ...
        if (HasUsedCharge == true && MoveDecison.IsDisplayingHappening == true)
        {
            ...
            Gridinfo.AllGrids[(int)Character_Info.LocationAction.y][(int)Character_Info.LocationAction.x].GetComponent<GridControl>().StatusIndex = 10;
            AreaEffect((int)Character_Info.LocationAction.x - 1, (int)Character_Info.LocationAction.y - 1, 3, 3);
